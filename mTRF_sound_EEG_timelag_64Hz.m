...
% first step for FDA train and test

%
%% band name
band_name = ' broadband 0.1-40Hz lambda2048';
...
for j = 1 : length(timelag)
    ...
    recon_AttendDecoder_audioA_corr = zeros(12,15);
    recon_AttendDecoder_audioB_corr = zeros(12,15);
    recon_UnattendDecoder_audioA_corr = zeros(12,15);
    recon_UnattendDecoder_audioB_corr = zeros(12,15);
    
    p_recon_AttendDecoder_audioA_corr = zeros(12,15);
    p_recon_AttendDecoder_audioB_corr = zeros(12,15);
    p_recon_UnattendDecoder_audioA_corr = zeros(12,15);
    p_recon_UnattendDecoder_audioB_corr = zeros(12,15);
    
    MSE_recon_AttendDecoder_audioA_corr = zeros(12,15);
    MSE_recon_UnattendDecoder_audioA_corr = zeros(12,15);
    MSE_recon_AttendDecoder_audioB_corr = zeros(12,15);
    MSE_recon_UnattendDecoder_audioB_corr = zeros(12,15);
    
    recon_AttendDecoder_audioA_corr_train = cell(12,15);
    recon_UnattendDecoder_audioA_corr_train = cell(12,15);
    recon_AttendDecoder_audioB_corr_train = cell(12,15);
    recon_UnattendDecoder_audioB_corr_train = cell(12,15);
    
    p_recon_AttendDecoder_audioA_corr_train = cell(12,15);
    p_recon_AttendDecoder_audioB_corr_train = cell(12,15);
    p_recon_UnattendDecoder_audioA_corr_train = cell(12,15);
    p_recon_UnattendDecoder_audioB_corr_train = cell(12,15);
    
    MSE_recon_AttendDecoder_audioA_corr_train = cell(12,15);
    MSE_recon_UnattendDecoder_audioA_corr_train = cell(12,15);
    MSE_recon_AttendDecoder_audioB_corr_train = cell(12,15);
    MSE_recon_UnattendDecoder_audioB_corr_train = cell(12,15);
        ...
        for story = 1 : 15
            ...
            for train_story = 1 : 15
                if train_story ~= story
                    ...
                    [recon_audio_attend_AttendDecoder_train,recon_AttendDecoder_audioA_corr_train{listener,story}(cnt_train_story),p_recon_AttendDecoder_audioA_corr_train{listener,story}(cnt_train_story),MSE_recon_AttendDecoder_audioA_corr_train{listener,story}(cnt_train_story)] =...
                    ...
                    [recon_audio_attend_unAttendDecoder_train,recon_AttendDecoder_audioB_corr_train{listener,story}(cnt_train_story),p_recon_AttendDecoder_audioB_corr_train{listener,story}(cnt_train_story),MSE_recon_AttendDecoder_audioB_corr_train{listener,story}(cnt_train_story)] =...
                    ...
                    [recon_audio_unattend_unAttendDecoder_train,recon_UnattendDecoder_audioA_corr_train{listener,story}(cnt_train_story),p_recon_UnattendDecoder_audioA_corr_train{listener,story}(cnt_train_story),MSE_recon_UnattendDecoder_audioA_corr_train{listener,story}(cnt_train_story)] =...
                    ...
                    [recon_audio_unattend_AttendDecoder_train,recon_UnattendDecoder_audioB_corr_train{listener,story}(cnt_train_story),p_recon_UnattendDecoder_audioB_corr_train{listener,story}(cnt_train_story),MSE_recon_UnattendDecoder_audioB_corr_train{listener,story}(cnt_train_story)] =...
                    ...
                    %
                    %                         [recon_audio_unattend_unAttendDecoder_train,recon_UnattendDecoder_audioA_corr_train{listener,story}(cnt_train_story),p_recon_UnattendDecoder_audioB_corr_train{listener,story}(cnt_train_story),MSE_recon_UnattendDecoder_audioA_corr_train{listener,story}(cnt_train_story)] =...
                    %                             mTRFpredict(zscore(story_train_audio_A'),zscore(story_train_EEG'),w_train_mTRF_unattend,Fs,1,start_time,end_time,con_train_mTRF_unattend);
                    %
                    %                         [recon_audio_unattend_AttendDecoder_train,recon_UnattendDecoder_audioB_corr_train{listener,story}(cnt_train_story),p_recon_UnattendDecoder_audioA_corr_train{listener,story}(cnt_train_story),MSE_recon_UnattendDecoder_audioB_corr_train{listener,story}(cnt_train_story)] =...
            ...
            [recon_audio_attend_AttendDecoder,recon_AttendDecoder_audioA_corr(listener,story),p_recon_AttendDecoder_audioA_corr(listener,story),MSE_recon_AttendDecoder_audioA_corr(listener,story)] =...
            ...
            [recon_audio_attend_unAttendDecoder,recon_AttendDecoder_audioB_corr(listener,story),p_recon_AttendDecoder_audioB_corr(listener,story),MSE_recon_AttendDecoder_audioB_corr(listener,story)] =...
            ...
            [recon_audio_unattend_unAttendDecoder,recon_UnattendDecoder_audioA_corr(listener,story),p_recon_UnattendDecoder_audioA_corr(listener,story),MSE_recon_UnattendDecoder_audioA_corr(listener,story)] =...
            ...
            [recon_audio_unattend_AttendDecoder,recon_UnattendDecoder_audioB_corr(listener,story),p_recon_UnattendDecoder_audioB_corr(listener,story),MSE_recon_UnattendDecoder_audioB_corr(listener,story)] =...
            ...
            %
            %                 [recon_audio_unattend_unAttendDecoder,recon_UnattendDecoder_audioA_corr(listener,story),p_recon_UnattendDecoder_audioB_corr(listener,story),MSE_recon_UnattendDecoder_audioA_corr(listener,story)] =...
            %                     mTRFpredict(zscore(story_predict_audio_A'),zscore(story_predict_EEG'),w_train_mTRF_unattend,Fs,1,start_time,end_time,con_train_mTRF_unattend);
            %
            %                 [recon_audio_unattend_AttendDecoder,recon_UnattendDecoder_audioB_corr(listener,story),p_recon_UnattendDecoder_audioA_corr(listener,story),MSE_recon_UnattendDecoder_audioB_corr(listener,story)] =...
    ...
    %     figure; plot(mean(recon_AttendDecoder_audioA_corr,2),'r');
    %     hold on; plot(mean(recon_AttendDecoder_audioB_corr,2),'b');
    ...
    %     figure; plot(mean(recon_UnattendDecoder_audioB_corr,2),'r');
    %     hold on; plot(mean(recon_UnattendDecoder_audioA_corr,2),'b');
    %     xlabel('Subject No.'); ylabel('r value')
    ...
    %     Decoding_result_attend_decoder = recon_AttendDecoder_audioA_corr-recon_AttendDecoder_audioB_corr;
    %     Individual_subjects_result_attend = sum(Decoding_result_attend_decoder>0,2)/15;
    %     mean(Individual_subjects_result_attend)
    %     Decoding_result_unattend_decoder = recon_UnattendDecoder_audioA_corr-recon_UnattendDecoder_audioB_corr;
    ...
    save(saveName,'recon_AttendDecoder_audioA_corr','recon_UnattendDecoder_audioB_corr' ,'recon_AttendDecoder_audioB_corr','recon_UnattendDecoder_audioA_corr',...
        'p_recon_AttendDecoder_audioA_corr','p_recon_UnattendDecoder_audioB_corr', 'p_recon_AttendDecoder_audioB_corr','p_recon_UnattendDecoder_audioA_corr',...
        'MSE_recon_AttendDecoder_audioA_corr','MSE_recon_UnattendDecoder_audioB_corr','MSE_recon_AttendDecoder_audioB_corr','MSE_recon_UnattendDecoder_audioA_corr',...
        'recon_AttendDecoder_audioA_corr_train','recon_UnattendDecoder_audioB_corr_train' ,'recon_AttendDecoder_audioB_corr_train','recon_UnattendDecoder_audioA_corr_train',...
        'p_recon_AttendDecoder_audioA_corr_train','p_recon_UnattendDecoder_audioB_corr_train', 'p_recon_AttendDecoder_audioB_corr_train','p_recon_UnattendDecoder_audioA_corr_train',...
        'MSE_recon_AttendDecoder_audioA_corr_train','MSE_recon_UnattendDecoder_audioB_corr_train','MSE_recon_AttendDecoder_audioB_corr_train','MSE_recon_UnattendDecoder_audioA_corr_train',...
